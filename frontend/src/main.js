        ...
        : el('section', { class: 'cert-wrap' }, [
            el('div', { style: 'width: min(1100px, 96vw);' }, [
              ...
              el('div', { style: 'display:flex; gap: 12px; align-items:flex-start; flex-wrap:wrap;' }, [
                el('div', { style: 'flex: 1 1 520px; min-width: min(520px, 96vw);' }, [
                  el('div', { class: 'muted', style: 'margin: 0 0 8px 0;', text: 'Audit v4' }),
                  el('img', { class: 'img-preview', alt: 'Generated display card (audit_v4)', src: auditUrl })
                ]),
                el('div', { style: 'flex: 1 1 520px; min-width: min(520px, 96vw);' }, [
                  el('div', { class: 'muted', style: 'margin: 0 0 8px 0;', text: 'KYC v4' }),
                  el('img', { class: 'img-preview', alt: 'Generated display card (kyc_v4)', src: kycUrl })
                ])
              ]),
