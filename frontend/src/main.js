...
// When deployed on Workers, we can implement the renderer in JS (no PHP needed).
// If images still fail, the per-image error hint guides the user to configure VITE_RENDER_URL.
const NEEDS_RENDERER_BACKEND = false;
